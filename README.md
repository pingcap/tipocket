...
Tipocket is inspired by [jepsen-io/jepsen](https://github.com/jepsen-io/jepsen), a famous library on distributed system field. Tipocket focuses on stability testing on TiDB, it uses [chaos-mesh](https://github.com/pingcap/chaos-mesh) to inject all-round kinds of nemesis on a TiDB cluster.
...
If you have a K8s cluster, you can use below commands to deploy and run the case on a TiDB cluster.
