...
func TestParseLog(t *testing.T) {
	...
	log, err = parseLog(`[2019/11/27 10:51:34.416 +08:00] [SUCCESS] Exec SQL BEGIN success`, 1)
	...
	log, err = parseLog(`[2019/11/27 10:51:22.479 +08:00] [SUCCESS] Exec SQL UPDATE sqlsmith.rpsfxc SET rpsfxc.vpmnuqnu=1614015085, rpsfxc.alvfuz=588064950, rpsfxc.soxjg=139378397, rpsfxc.bslhqvyn=421707098 WHERE rpsfxc.qhsro='2013-04-18 15:35:50' XOR rpsfxc.soxjg>351245791 OR rpsfxc.qhsro>'2053-07-09 00:00:31' XOR rpsfxc.obrdzbyj<_binary"4gJBz@]" success`, 2)
	assert.Equal(t, err, nil)
