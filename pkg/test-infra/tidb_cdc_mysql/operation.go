...
func (t *TidbOps) GetNodes(tc *TiDBCDCMySQLClusterRecommendation) ([]clusterTypes.Node, error) {
	pods := &corev1.PodList{}
...
func (t *TidbOps) GetClientNodes(tc *TiDBCDCMySQLClusterRecommendation) ([]clusterTypes.ClientNode, error) {
