...
type TiDBCDCMySQLClusterRecommendation struct {
...
func (t *TiDBCDCMySQLClusterRecommendation) Make() *v1alpha1.TidbCluster {
	return t.TidbCluster
}

func (t *TiDBCDCMySQLClusterRecommendation) EnablePump(replicas int32) *TiDBCDCMySQLClusterRecommendation {
...
func (t *TiDBCDCMySQLClusterRecommendation) PDReplicas(replicas int32) *TiDBCDCMySQLClusterRecommendation {
	t.TidbCluster.Spec.PD.Replicas = replicas
	return t
}

func (t *TiDBCDCMySQLClusterRecommendation) TiKVReplicas(replicas int32) *TiDBCDCMySQLClusterRecommendation {
	t.TidbCluster.Spec.TiKV.Replicas = replicas
	return t
}

func (t *TiDBCDCMySQLClusterRecommendation) TiDBReplicas(replicas int32) *TiDBCDCMySQLClusterRecommendation {
...
func RecommendedTiDBCluster(ns, name string) *TiDBCDCMySQLClusterRecommendation {
	enablePVReclaim, exposeStatus := true, true
	always := corev1.PullAlways

	return &TiDBCDCMySQLClusterRecommendation{
		NS:   ns,
		Name: name,
