...
func TestParseHistory(t *testing.T) {
	...
	assert.Equal(t, history[1], Op{Index: 1, Type: Ok, Value: txn1Mops}, "parse history, history[1]")
	assert.Equal(t, history[2], Op{Index: 2, Type: Invoke, Value: []Mop{Append{Key: "255", Value: 8}, Read{Key: "253", Value: nil}}}, "parse history, history[2]")
	...
	assert.Equal(t, history[4], Op{Index: 4, Type: Invoke, Value: txn3MopsInvoke}, "parse history, history[4]")
