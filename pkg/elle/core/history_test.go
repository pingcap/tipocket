...
func TestParseHistory(t *testing.T) {
	...
	assert.Equal(t, history[2], Op{Index: IntOptional{2}, Process: NewOptInt(1), Type: OpTypeInvoke, Value: &[]Mop{Append{Key: "255", Value: 8}, Read{Key: "253", Value: nil}}}, "parse history, history[2]")
	assert.Equal(t, history[3], Op{Index: IntOptional{3}, Type: OpTypeOk, Value: &[]Mop{Append{Key: "255", Value: 8}, Read{Key: "253", Value: []int{1, 3, 4}}}}, "parse history, history[3]")
